...
{
    /// <summary>
    /// Provides extension methods for the <see cref="DtmItemInfo"/> interface.
    /// </summary>
    public static class DtmItemInfoExtensions
    {
        public static DtmParameter ToDtmParameter(this DtmItemInfo dtmItemInfo, ParameterDataSourceKind parameterDataSourceKind)
        {
